 ...
 *   </li>
 * <li>{@link XmlAttachmentRef}: JSON does not support external attachments
 ...
 */
public class JakartaJaxbAnnotationIntrospector
        ...
        Versioned
{
     ...
     * or {@link JsonInclude.Include#NON_EMPTY}.
     *
     * @since 2.7
     */
     ...
     */
    @Deprecated
    public JakartaJaxbAnnotationIntrospector() {
        this(TypeFactory.defaultInstance());
    }

    public JakartaJaxbAnnotationIntrospector(MapperConfig<?> config) {
        this(config.getTypeFactory());
    }

    public JakartaJaxbAnnotationIntrospector(TypeFactory typeFactory) {
     ...
     */
    public JakartaJaxbAnnotationIntrospector(TypeFactory typeFactory, boolean ignoreXmlIDREF)
    {
     ...
     * @since 2.7
     */
    public JakartaJaxbAnnotationIntrospector setNonNillableInclusion(JsonInclude.Include incl) {
...
*/
    ...
    protected Converter<Object,Object> _converter(XmlAdapter<?,?> adapter, boolean forSerialization)
    {
        ...
        if (forSerialization) {
            return new JakartaAdapterConverter(adapter, pt[1], pt[0], forSerialization);
        }
        return new JakartaAdapterConverter(adapter, pt[0], pt[1], forSerialization);
    }

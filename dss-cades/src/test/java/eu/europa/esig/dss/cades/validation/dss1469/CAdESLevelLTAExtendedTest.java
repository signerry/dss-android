...
public class CAdESLevelLTAExtendedTest extends AbstractCAdESTestValidation {
	...
	protected DSSDocument getSignedDocument() {
		return new FileDocument(TestUtils.getResourceAsFile("validation/dss-1469/cadesLTAwithATv2.sig"));
	}
	
	@Override
	protected List<DSSDocument> getDetachedContents() {
		return Arrays.asList(new FileDocument(TestUtils.getResourceAsFile("validation/dss-1469/screenshot2.png")));
	}

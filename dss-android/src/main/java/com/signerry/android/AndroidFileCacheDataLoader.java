 ...
 */
public class AndroidFileCacheDataLoader implements DataLoader, DSSFileLoader {

    private static final long serialVersionUID = 1028849693098211169L;

    private static final Logger LOG = LoggerFactory.getLogger(AndroidFileCacheDataLoader.class);
     ...
     * Empty constructor
     */
    public AndroidFileCacheDataLoader(Context androidContext) {
     ...
     */
    public AndroidFileCacheDataLoader(DataLoader dataLoader, Context androidContext) {
    ...
    private byte[] getLocalFileContent(final String urlString) throws DSSException {
        ...
        InputStream is = null;
        try {
            is = androidContext.getAssets().open(urlString);
